...
namespace TwoWaySync.Services
{
    ...
    {
        public List<RemoteTaskDto> GetTasks(long lastModifiedFrom, int offset, int pageSize) => new List<RemoteTaskDto>();
        ...
        public List<RemoteCompanyDto> GetCompanies(long lastModifiedFrom, int offset, int pageSize, string name) => new List<RemoteCompanyDto>();
